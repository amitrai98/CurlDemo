 ...
 */
public class MyPageTranslator implements ViewPager.PageTransformer {
...
//    https://nickbradbury.com/2014/09/03/using-androids-viewpager-pagetransformer/

    private final TransformType mTransformType;

    MyPageTranslator(TransformType transformType) {
